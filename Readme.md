[![Build and test the esy package](https://github.com/ManasJayanth/esy-expat/actions/workflows/workflow.yml/badge.svg)](https://github.com/ManasJayanth/esy-expat/actions/workflows/workflow.yml)

# esy-expat

`esy-expat` is sample package, [`expat`](https://libexpat.github.io/), packaged for [`esy`](https://esy.sh/).
...
`esy-expat` is deployed on NPM can be found
[here](https://www.npmjs.com/package/TODO).

You can simply run `esy add esy-expat` to install it, or specify it in
